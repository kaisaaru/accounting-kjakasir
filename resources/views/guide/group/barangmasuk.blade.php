                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">Panduan Aplikasi (Barang Masuk)</h4>
                            </div>
                        </div>
                        <div class="iq-card-body">
                            ...
                            <div class="iq-card anak">
                                ...
                                <div class="iq-card-body hidden" id="po-body">
                                    <p><strong>Purchase Order (PO)</strong> merupakan fitur yang dapat membuat pengguna
                                        melakukan pembelian barang dari supplier.</p>
                                    <p>Oke, langsung saja ke cara penggunaan <strong>Purchase Order (PO)</strong>. Tetapi
                                        sebelum memulai purchase
                                        order, pastikan untuk mengisi relasi, kategori, kelompok, dan barang.</p>
                                    <ol>
                                        <li>Klik tombol tambah di halaman purchase order.</li>
                            ...
                            <div class="iq-card anak">
                                ...
                                <div class="iq-card-body hidden" id="pb-body">
                                    <p><strong>Penerimaan Barang (PB)</strong>merupakan fitur untuk melanjutkan proses
                                        barang masuk setelah purchase order, dan penerimaan barang juga termasuk penting
                                        agar user dapat melanjutkan ketahap barang masuk terakhir yaitu faktur beli.</p>
                                    <p>Oke, langsung saja ke cara penggunaan <strong>Penerimaan Barang (PB)</strong>. Tetapi
                                    ...
                                    <ol>
                                        ...
                                        <img src="{{ asset('assets/images/barangmasuk/pb (4).gif') }}" alt=""
                                            width="55%">
                                        <li>Pilih purchase order yang akan anda buat penerimaan barangnya.</li>
