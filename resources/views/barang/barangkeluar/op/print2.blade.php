...
<head>
    ...
    <title>Print Surat Order Penjualan</title>
</head>
<style>
    /* Main Border */
    #absensi-table {
...
<body style="background: white">
    ...
    <div id="printableArea">
        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
            ...
            <div style="flex: 10%; text-align: left;">
                <span>
                    <div class="text-muted">: {{ $OrderPenjualan->id_so ?? 'Tidak ada data' }}</div>
                    <div class="text-muted">: {{ $OrderPenjualan->tanggal_op }}</div>
                    <div class="text-muted">: {{ $OrderPenjualan->jatuh_tempo }}</div>
                </span>
            </div>
        </div>
        ...
        <div style="display: flex; justify-content: space-between;">
            <div>
                <div class="text-muted" style="font-weight: bold;">Kepada :
                    {{ Auth::user()->perusahaan->nama_perusahaan }}</div>
                <div class="text-muted">{{ Auth::user()->perusahaan->alamat_gudang }}</div>
            </div>
            <div>
                <div class="text-muted" style="font-weight: bold;">Dikirim ke : PT
                    {{ $OrderPenjualan->nama_perusahaan }}</div>
                <div class="text-muted">{{ $perusahaan->alamat_kantor }}</div>
            </div>
            <div>
                ‎
            </div>
        ...
        <div>
            <div class="text-muted" align="right">Total: {{ number_format($jumlah ?? 0, 0, ',', '.') }}</div>
        </div>
        <p></p>
        <p></p>
        <p></p>
