    ...
    <div id="content-page" class="content-page">
            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title">Faktur Jual (FJ)</h4>
                    </div>
                </div>
                <div class="iq-card-body">
                    ...
                    <form class="form-horizontal" action="/fakturjual/{{ $id_sj }}/create" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-sm-2 align-self-center mb-0" for="tanggal_sj">ID Faktur Jual
                                (FJ)</label>
                            <div class="col-sm-5">
                            ...
                            <div class="col-sm-2">
                                <button type="button" class="btn btn-outline-primary" data-toggle="modal"
                                    data-target="#detailfj">Detail FJ</button>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" id="detailfj">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary" id="fjFormSubmit">Tambah</button>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#fjFormSubmit').click(function(event) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var method = 'get';
                            var action = 'Faktur Jual';
                            var id = id_fj;
                            var url = '/fakturjual/' + id_sj + '/create';
                            ...
                            $.ajax({
                                ...
                                complete: function() {
                                    ...
                                    $('#fjFormSubmit').prop('disabled', false);
                                }
                            });
                        } else {
