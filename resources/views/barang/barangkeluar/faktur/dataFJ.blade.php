        ...
        <div class="container-fluid">
            <div class="iq-card-body">
                ...
                <div class="iq-header-title">
                    <h4 class="card-title">Daftar Faktur Penjualan (FJ)</h4>
                    ...
                    <div class="col-lg-12">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                            <div class="iq-card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h4 class="card-title">Faktur Jual</h4>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($fj as $fjs)
                                                <tr>
                                                    ...
                                                    <td style="border-top: 2px solid #ddd; border-bottom: 1px solid #ddd;">
                                                        <strong>{{ $fjs->id_fj }}</strong>
                                                    </td>
                                                    <td style="border-top: 2px solid #ddd; border-bottom: 1px solid #ddd;">
                                                        <strong>{{ $fjs->id_sj }}</strong>
                                                    </td>
                                                    <td style="border-top: 2px solid #ddd; border-bottom: 1px solid #ddd;">
                                                        {{ $fjs->tanggal_fj }}
                                                    </td>
                                                    <td style="border-top: 2px solid #ddd; border-bottom: 1px solid #ddd;">
                                                        ...
                                                        <button class="btn btn-outline-primary mb-3" data-toggle="modal"
                                                            data-target="#detailfb{{ $fjs->id_fj }}">
                                                            Detail
                                                        </button>
                                                    </td>
                                                    <td style="border-top: 2px solid #ddd; border-bottom: 1px solid #ddd;">
                                                    ...
                                                    <td style="border-top: 2px solid #ddd; border-bottom: 1px solid #ddd;">
                                                        <a class="btn btn-outline-primary mb-3"
                                                            href="/print/fakturjual/{{ $fjs->id_fj }}/{{ $fjs->id_sj }}">Print</a>
                                                        {{-- edit --}}
                                                        ...
                                                        <div class="modal fade bd-example-modal-xl"
                                                            id="detailfb{{ $fjs->id_fj }}" tabindex="-1"
    ...
    <script>
        function confirmAction(action, id) {
            ...
            if (confirmation) {
                ...
                } else if (action === "faktur") {
                    window.location.href = "/dataPB/faktur/" + id;
                }
            } else {
