        ...
        <table id="absensi-table" class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="debit" style="text-align: right;">Debet</th>
                    <th scope="col" class="credit" style="text-align: right;">Kredit</th>
                    <th scope="col" style="text-align: right;">Saldo Kumulatif</th>
                </tr>
            </thead>
            <tbody>
                <tr>
            ...
            <tbody>
                <tr style="border-top: 2px solid black;">
                    ...
                    <td style="text-align: right;">{{ number_format($totaldebet, 0, ',', '.') }}</td>
